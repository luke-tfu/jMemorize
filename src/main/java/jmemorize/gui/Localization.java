...
/**
 * This class is used to query language/locale related strings and date formatters.
 * 
 * @author djemili
 */
public class Localization {
    ...
    public static final DateFormat SHORT_DATE_FORMATER = DateFormat.getDateTimeInstance(DateFormat.SHORT,
            DateFormat.SHORT);

    public static final DateFormat LONG_DATE_FORMATER = DateFormat.getDateTimeInstance(DateFormat.FULL,
            DateFormat.MEDIUM);

    public static final DateFormat SHORT_TIME_FORMATER = DateFormat.getTimeInstance(DateFormat.SHORT); // just
                                                                                                       // hours:minutes
    ...
    /**
     * @return the string associated with key in the default or child bundle or an empty string if no such string
     *         available.
     */
    ...
    /**
     * @return the string associated with given key1 or the string assoiated with given key2 if no string is associated
     *         with key1 in the sub bundle or the string associated with given key in the default bundle or a debug
    ...
    /**
     * The list of available languages is stored in the file <tt>/resource/text/langs.txt</tt>. Every line holds a
     * string that represents the language (and optionally the country) code.
     * 
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (m.matches()) {
                    ...
                    locales.add(country != null ? new Locale(language, country) : new Locale(language));
                }
            }
    ...
    /**
     * Compares the machines default locale with all available translations. If the default locale is available as
     * translation the machines locale is returned. Otherwise the english language locale is returned as default.
     */
