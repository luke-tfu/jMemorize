...
/**
 * A category tree that shows a visual representation of the categories. It also has support for drag'n'drop actions and
 * renaming categories.
 * 
 * @author djemili
 */
public class CategoryTree extends JTree implements CategoryObserver, SelectionProvider {
    ...
    private class CategoryTreeModel extends DefaultTreeModel {
        ...
        /**
         * Instead of overwriting userObject like the super method does, the input is set as the new name of the
         * category.
         * 
    ...
    /**
     * @return <code>true</code> if the selected category is pending. This is the case if the category was selected by
