...
public class CardTable extends JTable implements Settings.CardFontObserver, SelectionProvider, ProgramEndObserver {
    ...
    /**
     * A TableCellRenderer that displays cells with Strings and a specific string suffix.
     */
    ...
    /**
     * A TableCellRenderer that renders cells which show expiration dates. This renderer displays a little icon with
    ...
    public class ViewModel extends AbstractTableModel {
        ...
        /**
         * Set the model column index and direction by which this table should be sorted.
         * 
         * @param modelIndex
     ...
     * @param prefs
     *            the Preferences object which should be used to load/store preferences of this card table.
    ...
    /**
     * Hook the card context menu to given JComponent. Attaches a MouseListener to the given component which checks for
     * right mouse button clicks and shows the context menu.
     */
     ...
     * @param modelIndex
     *            the index in model space (is'nt affected by the current visual shown card columns or the way they are
