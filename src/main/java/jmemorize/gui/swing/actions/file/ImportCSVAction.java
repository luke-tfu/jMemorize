...
public class ImportCSVAction extends AbstractImportAction {
    ...
    public static Charset showCharsetChooser(JFrame owner) {
        ...
        String selection = (String) JOptionPane.showInputDialog(owner,
                Localization.get("MainFrame.SELECT_CHARACTER_SET"), Localization.get("MainFrame.CHARACTER_SET"),
                JOptionPane.QUESTION_MESSAGE, null, charsets, "ISO-8859-1");

        /*
         * someone reported a bug (with stack tracke) where altough selection was tested for null, before calling the
         * method, a illegal-null-argument exception was thrown - don't ask how this can be possible
         */
