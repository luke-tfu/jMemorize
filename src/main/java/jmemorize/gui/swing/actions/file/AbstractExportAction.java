...
public abstract class AbstractExportAction extends AbstractSessionDisabledAction {
    /**
     * Displays a Save As or Export dialog, and to confirm overwrites, and to attach specified file extension.
     * 
    ...
    public static File showSaveDialog(JFrame frame, ExtensionFileFilter fileFilter) {
        ...
        while (true) {
            ...
            if (file.exists()) {
                ...
                int act = JOptionPane.showConfirmDialog(frame, text + " " + file.toString(), title,
