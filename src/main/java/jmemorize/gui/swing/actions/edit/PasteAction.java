...
/**
 * An action that invokes the generic Swing PASTE action on the current focus owner.
 * 
 * @author djemili
 */
public class PasteAction extends AbstractAction2 implements SelectionObserver {
    ...
    private void updateEnablement() {
        ...
        setEnabled(mainFrame != null && m_selectionProvider != null && !Main.getInstance().isSessionRunning()
