...
/**
 * A panel that is used in the learn sidebar and shows how many cards have been learned in the running learn session.
 * 
 * @author djemili
 */
public class CardCounterPanel extends JPanel {
    ...
    private ChartPanel buildPiePanel() {
        ...
        /*
         * RED_FLAG this is a WORKAROUND TO a JFreeChart bug (as of 1.0.4) which causes an affine transform to be
         * applied to charts smaller than 300x200. If the minimum sizes are not set to the same value, the chart and
         * legend are scaled by the proprtion! see http://www.jfree.org/phpBB2/viewtopic.php?t=16972
         */
    ...
    private float[] getValues() {
        ...
        for (int i = 0; i < m_cards.size(); i++) {
            ...
            if (m_session.getPassedCards().contains(card) || m_session.getRelearnedCards().contains(card)) {
                vals[i] = 1f;
            } else {
