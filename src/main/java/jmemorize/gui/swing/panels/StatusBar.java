...
public class StatusBar extends JPanel {
    ...
    /**
     * Sets the text that should appear on the left part of the status bar. The right side is always reserved to show
     * the number of cards.
     * 
     * @param text
     */
    ...
    /**
     * Sets currently shown cards. This is used for the right part of the status bar that shows the number of currently
     * displayed cards.
     * 
     * @param cards
     *            The cards that are currently displayed.
     */
