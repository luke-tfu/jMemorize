...
public class CardPanel extends JPanel {
    /**
     * A interface that allows to listen for textchanges to the card side text panes. Use
    ...
    private abstract class AbstractStyledTextAction extends StyledTextAction {
        ...
        /**
         * @return <code>true</code> if the style associated with this text action is enabled. <code>false</code>
         *         otherwise.
         */
        public abstract boolean hasStyle(AttributeSet attr);

        /**
         * Enables/disables the style associated with this text action in the given attributes.
         */
    ...
    /**
     * @param editable
     *            <code>true</code> if front/back side textpanes should be editable. <code>false</code> otherwise.
     */
    ...
    /**
     * Adds a text observer that will be triggered when the text of the frontside textpane or backside textpane is
     * changed by the users key input.
     * 
     * @param observer
    ...
    /**
     * Notify all observers that the text of the frontside textpane or backside textpane has been changed by the users
     * keyinput.
     */
