...
/**
 * A panel that shows a table which is filled with cards. Shows two buttons at the top that go to previous/next deck.
 * 
 * @author djemili
 */
public class DeckTablePanel extends JPanel implements CategoryObserver {
    ...
    /**
     * @param deck
     *            If deck is -1 then all decks are shown, otherwise only given deck is shown.
     */
