...
public class CardSidePanel extends JPanel {
    ...
    private class ScaledImagePanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g.drawImage(m_image, left, top, left + w - 2 * padding, top + h - 2 * padding, 0, 0, imgWidth, imgHeight,
                    null);
        }
    }
    ...
    /**
     * Sets the text of one EditorPane. Using EditorPane#setText caused some weird rendering artifacts. This methods
     * fixes this by completly replacing the document by a new one.
     */
    ...
    public void addCaretListener(CaretListener listener) {
        ...
        /*
         * Our problem is that the TextPane inserts new CaretListeners at the first position. Because we add our text
         * actions after the editor kit has already been implictly set, they will get fired before the AttributeTracker
         * in StyledEditorKit (which also listens as caret listener) has the chance to update the input attributes which
         * our text actions rely on. By resetting the editor kit, the editor kit will be removed from the caret
         * listeners and reinserted at the first position, so that our text actions can correctly access the current
         * input attributes.
         */
