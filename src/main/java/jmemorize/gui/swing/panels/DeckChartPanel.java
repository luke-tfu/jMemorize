 ...
 * representation of the current card distribution among all decks in form of a 3D stacked bar chart.
 * 
 * @author djemili
 */
public class DeckChartPanel extends JPanel implements CategoryObserver {
    ...
    private class MyBarRenderer extends StackedBarRenderer3D {
        ...
        /*
         * NOTE this is a workaround. JFreeChart appears to insist on drawing bars even if they are of zero width. To
        ...
        protected void drawStackVertical(List values, Comparable category, Graphics2D g2,
            ...
            super.drawStackVertical(prunedValues, category, g2, state, dataArea, plot, domainAxis, rangeAxis, dataset);
        }
    }
    ...
    /**
     * Sets the values for the column with given id. This method also handles the order in which the rows will appear in
     * the column.
     */
