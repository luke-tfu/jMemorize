 ...
 * @author djemili
 */
public class LearnPanel extends JPanel implements SelectionProvider, LearnSessionObserver, LearnCardObserver {
    ...
    public void sessionStarted(LearnSession session) {
        ...
        int sidesToTest = settings.getAmountToTest(true) + settings.getAmountToTest(false);

        m_isPartialProgressMode = settings.getSidesMode() == LearnSettings.SIDES_BOTH && (sidesToTest > 1);
