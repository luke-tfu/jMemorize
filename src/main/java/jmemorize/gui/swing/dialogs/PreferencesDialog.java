...
public class PreferencesDialog extends JDialog {
    private static final String[] FONT_SIZES = { "8", "9", "10", "11", "12", "14", "16", "18", "20", "22", "24", "26",
            "28", "32", "36", "72", "92", "128" };
    ...
    public PreferencesDialog(MainFrame frame) {
        ...
        // alignment combo box
        m_alignList.setListData(new String[] { Localization.get(LC.ALIGN_LEFT), Localization.get(LC.ALIGN_CENTER),
