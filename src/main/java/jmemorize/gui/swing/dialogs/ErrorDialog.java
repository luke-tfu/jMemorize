...
public class ErrorDialog extends JDialog {
    ...
    /**
     * Creates a new modal error dialog that shows given the message associated with given exception and also the stack
     * trace if extended.
     */
    ...
    /**
     * Creates a new modal error dialog that shows given message and if extended also the stack trace of given
     * exception.
     * 
     * @param message
     *            the message that should appear instead of the message given by the exception.
     */
