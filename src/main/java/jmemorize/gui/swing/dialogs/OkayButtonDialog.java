...
/**
 * A simple dialog that displays a main panel with a button bar below which contains a single okay-button.
 * 
 * @author djemili
 */
public class OkayButtonDialog extends JDialog {
    public OkayButtonDialog(Frame father, String title, boolean modal, JComponent component) {
