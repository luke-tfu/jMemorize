...
public class GeneralTransferHandler extends TransferHandler {
    ...
    /**
     * Represents a formatted text and it source document. We need the source for CUT-operations where we need to remove
     * the formatted section from the original document.
     */
