...
public class EditCardFrame extends EscapableFrame implements CategoryObserver, SelectionProvider {
     ...
     * 
     * @param cards
     *            the cards that belong to the context of the card that is to be edited. These cards are used to allow
     *            browsing to next and previous card. Therefore the card given on the former parameter is usually also
     *            part of this list. The usual mode is to show the currently selected card and to give all other cards
     *            that are part of the same card table/learn history etc. as additional cards.
     * 
     * @param category
    ...
    public void showCard(Card card, List<Card> cards, Category category, String searchText, int side,
            boolean ignoreCase) {
    ...
    /**
     * If the content of the text panes differ from the currently saved card entries, this will bring up a dialog that
     * asks if the user wants to save the changes. If yes is selected the card sides are saved.
     * 
     * This should be called everytime there is the chance of losing card informations.
     * 
    ...
    private boolean isChanged() {
        boolean categoryChanged = m_currentCard.getCategory() != m_cardPanel.getCategoryComboBox()
                .getSelectedCategory();
        ...
        boolean textChanged = !m_cardPanel.getFrontText().equals(frontSide.getText())
    ...
    /**
     * Updates the actions of this EditCardFrame i.e. enabling/disabling certain buttons.
     */
