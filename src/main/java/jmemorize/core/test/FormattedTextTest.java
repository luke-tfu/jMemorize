...
public class FormattedTextTest extends TestCase {
    ...
    /**
     * Asserts that the style is still set correctly on a styled document after encoding the document into a string
     * representation and decoding it back into a styled document again.
     */
