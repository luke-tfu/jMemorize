...
public class CardTest extends TestCase {
    ...
    public void testAddImage() {
        ...
        images.add("bar.png");
        assertEquals("image list should not be stored as reference to argument", originalImages,
                m_card.getFrontSide().getImages());
    }
    ...
    public void testCardClonesImages() {
        ...
        assertEquals("clone should not reference originals image list", images, clonedCard.getFrontSide().getImages());
    }
