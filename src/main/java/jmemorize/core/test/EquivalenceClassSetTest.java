...
public class EquivalenceClassSetTest extends TestCase {
    ...
    public void internalTestLoopIteratorAddToClass(int addVal, boolean expired, boolean expectedInCycle) {
    ...
    public void internalTestLoopIteratorRemoveList(List remValues, int expectedCycleReduction,
            int expectedFirstModVal) {
        // remove something from a class and test loop iterator behavior
        Iterator loopIter = mod3EqvSet.loopIterator();
