...
public class ImageRepository {
    ...
    /**
     * Converts the given list of image icons into a list of image IDs. This is done by using the description field of
     * ImageIcon. If the image icon was already loaded from the image repository, the description will begin with
     * IMG_ID_PREFIX, otherwise it will be a new image that wasn't added to the repository yet.
     */
