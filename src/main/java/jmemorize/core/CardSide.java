...
/**
 * A card is made up of two card sides which can contain various contents, the most important being text.
 * 
 * @author djemili
 */
public class CardSide implements Cloneable {
    ...
    /**
     * Note that using this method won't modify the modification date of the card. Use
     * {@link Card#setSides(String, String)} instead for modifications done by the user.
     */
